                ...
                <div class="flex justify-between items-center mb-5 animate-fade-in-up">
                    <div x-data="{ openKelas: false }">
                        ...
                        <div x-show="openKelas" x-cloak
                            ...
                            <div @click.away="openKelas = false"
                                class="bg-white dark:bg-gray-800 rounded-3xl shadow-2xl w-full max-w-md p-6 animate-zoom-in">
                                <h3 class="text-xl font-black text-gray-800 dark:text-gray-100 mb-4 border-b pb-3">Tambah Kelas</h3>
                                <form action="{{route('kelas.store')}}" method="POST" class="space-y-4">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" name="nama_kelas"
                                            class="w-full rounded-2xl border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white px-4 py-3 focus:ring-indigo-500 focus:border-indigo-500" placeholder="cth: X-1">
                                    </div>
                                    <div class="flex justify-end gap-3 pt-4">
                                        <button type="button" @click="openKelas = false"
