            ...
            <section x-data="kelasData()">
                ...
                <div x-show="openAddModal" 
                    ...
                    <div @click.away="openAddModal = false"
                        ...
                        <h3 class="text-xl font-black text-gray-800 dark:text-gray-100 mb-4 border-b pb-3">Tambah Kelas Baru</h3>
                ...
                <div x-show="openEditModal" 
                    ...
                    <div @click.away="openEditModal = false"
                         ...
                         x-transition:leave-start="opacity-100 scale-100"
                         x-transition:leave-end="opacity-0 scale-90">
                        <h2 class="text-xl font-black mb-4 text-gray-800 dark:text-white border-b pb-3">Edit Data Kelas</h2>
                        <form :action="`{{ url('admin/kelas') }}/${editId}`" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="mb-4">
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Nama Kelas</label>
