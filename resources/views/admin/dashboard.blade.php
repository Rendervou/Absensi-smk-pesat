                    ...
                    <div class="flex flex-col xl:flex-row items-start xl:items-center justify-between gap-6 relative z-10">
                        <div class="flex-1">
                            ...
                            <h3 class="text-3xl font-black text-gray-800 dark:text-gray-100 mb-2">
                                Selamat datang kembali! <span class="wave">👋</span>
                            </h3>
                        ...
                        <div class="flex flex-col sm:flex-row gap-4 w-full xl:w-auto">
                            <button type="submit" class="flex items-center gap-2 px-6 py-3 bg-gray-500 hover:bg-gray-600 text-white rounded-xl text-base font-semibold transition-all duration-200 shadow-lg">
                    ...
                    <div class="relative z-10">
                        <div class="flex items-start justify-between mb-6">
                            <div class="flex-1">
                                ...
                                <h2 class="text-5xl font-black mb-1 counter-number leading-none" data-target="{{ $totalSiswa }}">0</h2>
                            </div>
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex-1 bg-white/20 rounded-full h-3 overflow-hidden shadow-inner">
                                <div class="bg-gradient-to-r from-white via-slate-200 to-white h-full rounded-full progress-bar shadow-sm" style="--progress-width: 100%;"></div>
                            </div>
                            <span class="text-xs text-slate-300 ml-4 font-bold">100%</span>
                        </div>
                    </div>
                </div>
