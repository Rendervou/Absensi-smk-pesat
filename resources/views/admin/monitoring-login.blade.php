    ...
    <div class="py-8 bg-gradient-to-br from-green-50 via-white to-emerald-50 dark:from-gray-900 dark:via-gray-800 dark:to-emerald-900 min-h-screen">
        <div class="w-full mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                ...
                <!-- Total Admin -->
                <div class="bg-gradient-to-br from-purple-600 via-indigo-500 to-blue-600 text-white rounded-3xl shadow-2xl p-6 transform hover:scale-105 transition-all duration-300">
                    <div class="flex items-center justify-between mb-4">
                        <div>
                            <p class="text-purple-100 text-xs font-bold uppercase tracking-wider mb-1">Admin Online</p>
                            <h3 id="stat-admin" class="text-4xl font-black">0</h3>
                        </div>
                        <div class="w-14 h-14 bg-white/20 backdrop-blur-sm rounded-2xl flex items-center justify-center">
                            <svg class="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="text-sm font-semibold opacity-90">Administrator</div>
                </div>
