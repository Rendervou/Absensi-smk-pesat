                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            ...
                            <input 
                                ...
                                class="input-field block w-full pl-10 pr-3 py-3 text-white placeholder-slate-400 rounded-xl focus:outline-none focus:ring-0 transition-all duration-300"
                                placeholder="Masukkan nama pengguna"
                            >
                        </div>
                        <!-- Error message placeholder -->
                        <div class="text-red-300 text-sm mt-1 hidden">
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            ...
                            <input 
                                ...
                                class="input-field block w-full pl-10 pr-12 py-3 text-white placeholder-slate-400 rounded-xl focus:outline-none focus:ring-0 transition-all duration-300"
