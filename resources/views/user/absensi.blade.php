    ...
    <section class="p-3 sm:p-5">
        ...
        <form action="{{route('presensi.index')}}" method="get" class="flex mb-10 items-center gap-5">
            <select id="kelas" name="kelas"
                class="w-40 bg-gray-50 dark:bg-gray-800 border border-gray-300 dark:border-gray-600 
            ...
            <button type="submit"
                class="bg-orange-500 hover:bg-orange-600 dark:bg-orange-600 dark:hover:bg-orange-700
                       w-36 py-2 rounded-lg text-white transition">
                Cari
            </button>
        </form>
        ...
        <form>
            <div class="overflow-hidden rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm">
                <table class="w-full">
                        ...
                        <tr>
                            <th class="px-6 py-4 text-left text-xs font-bold text-gray-600 dark:text-gray-300 uppercase tracking-wider border-b dark:border-gray-700">
                                <div class="flex items-center gap-2">
                                    <span class="w-8 h-8 bg-blue-100 dark:bg-blue-900 text-blue-600 dark:text-blue-300 rounded-full flex items-center justify-center text-sm font-bold">#</span>
                                    No.
                                </div>
                            </th>
                            <th class="px-6 py-4 text-left text-xs font-bold text-gray-600 dark:text-gray-300 uppercase tracking-wider border-b dark:border-gray-700">
                    ...
                    @foreach ($rombels as $s)
                        <tbody class="bg-white dark:bg-[#1D283A] dark:text-gray-200 divide-y divide-gray-200 dark:divide-gray-700">
                            <tr class="hover:bg-gray-50 dark:hover:bg-slate-800 transition-colors duration-150">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        <div>
                                            <h3 class="text-sm font-semibold text-gray-900 dark:text-gray-200 uppercase">{{$s->nama_siswa}}</h3>
                                    ...
                                    <fieldset class="flex justify-around items-center gap-10">
                                        <div class="flex items-center mb-4">
                                            <input id="kehadiran-opsi-1" type="radio" name="kehadiran_{{ $s->id_siswa }}"
                                                value="hadir"
                                                class="w-4 h-4 border-gray-300 dark:border-gray-600 focus:ring-2 focus:ring-blue-300 dark:focus:ring-blue-600 dark:bg-gray-700"
                                                checked>
            ...
            <div class="flex justify-end mt-4">
                <button type="submit"
                    class="rounded-lg bg-blue-600 hover:bg-blue-700 text-white transition text-sm w-52 py-3 mb-2">
                    Simpan
                </button>
            </div>
        </form>
